...
export const rentalItems: RentalItem[] = [
  ...
  },
  {
    id: 'rent9',
    name: 'Yellow Tractor',
    description: 'A reliable yellow tractor for your basic farming needs.',
    pricePerDay: 200,
    category: 'Farming Equipment',
    imageId: 'yellow-tractor',
    color: '#FFD700',
  },
  {
    id: 'rent10',
    name: 'Red Tractor',
    description: 'A more powerful red tractor for demanding agricultural tasks.',
    pricePerDay: 350,
    category: 'Farming Equipment',
    imageId: 'red-tractor',
    color: '#DC143C',
  },
  {
    id: 'rent11',
    name: 'Green Tractor',
    description: 'The top-of-the-line green tractor, offering maximum power and efficiency.',
    pricePerDay: 500,
    category: 'Farming Equipment',
    imageId: 'green-tractor',
    color: '#228B22',
  },
];
